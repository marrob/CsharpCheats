...
{
    [TestFixture]
    public class File_Io_Log_Service
    {
        [Test]
        public void HelloWorld()
        {
            IoLog.Instance.FilePath = @"D:\File_Io_Log_Service.txt";
            IoLog.Instance.WriteLine("First");
            IoLog.Instance.WriteLine("Second", new byte[] { 0x0A, 0x0B });
        }
    }
